...
function [errorLine] = Dextractfeature_v1(idxBegin,idxEnd,strWSIPath,flag_epistroma,strPathIM,strSavePath,strEpiStrMaskPath,strNucleiMaskPath,flag_have_nulei_mask,flag_nuclei_cluster_finding,image_format,flag_Hosoya,flag_haralick,flag_CCM,flag_WSI,para_nulei_scale_low,para_nulei_scale_high)
...
if flag_epistroma
    ...
    dirIM=dir([strPathIM '*' image_format]);
end
        ...
        if exist(strSaveCur,'file')~=2
            if flag_have_nulei_mask
                ...
                try
                    ...
                    try
                        [nuclei, properties] = nucleiSegmentationV3(I_normRed,p); %show(I(:,:,1));
                    catch ME
                        errorLine = 202;
                        disp('error in nucleiSegmentation. Skipping');
                        continue
                    end
                    %%%% check
...
%             bwNuclei_stroma
        ...
        if exist(str,'file')~=2
            ...
            %note I can't find v2, so I used v1 instead
        ...
        if exist(str,'file')~=2
            ...
            [feats,description] = Lharalick_img_nuclei_wise(rgb2gray(I),bwNuclei,Num_level4Haralick_nuclei_wise);
        ...
        % this is good/reasonable for 40x image
...
%             para.bandWidth_features=[60;10];% bandwidth of in the feature space
            para.bandwidth_min_features=[60;10]; % you should check the visual to determine the parameters
            para.bandwidth_max_features=[120;20];
            para.bandwidth_res_features=[60;10];
